        ...
        <div class="col-12 offcanvas-mainbar">
            ...
            <div class="profile-header">
                ...
                <div class="profile-cover-wrapper">
                    ...
                    <!-- cropped-cover -->
                    <img class="js_position-cover-cropped js_lightbox"
                        data-init-position="{$spage['page_cover_position']}" data-id="{$spage['page_cover_id']}"
                        data-image="{$spage['page_cover_full']}" data-context="album" src="{$spage['page_cover']}"
                        alt="{$spage['page_title']}">
                    <!-- cropped-cover -->
                    {/if}
                    ...
                    <div class="profile-cover-buttons">
                        <div class="profile-cover-change">
                            <i class="fa fa-camera js_x-uploader" data-handle="cover-page"
                        ...
                        <div class="profile-cover-position {if !$spage['page_cover']}x-hidden{/if}">
                            ...
                            <i class="fa fa-crop-alt js_init-position-picture" data-handle="page"
                                data-id="{$spage['page_id']}"></i>
                        </div>
                        ...
                        <div class="profile-cover-delete {if !$spage['page_cover']}x-hidden{/if}">
                            <i class="fa fa-trash js_delete-cover" data-handle="cover-page"
                                data-id="{$spage['page_id']}"></i>
                        </div>
                    </div>
                    <!-- buttons -->
                ...
                <div class="profile-avatar-wrapper">
                    <img {if !$spage['page_picture_default']} class="js_lightbox" data-id="{$spage['page_picture_id']}"
                        data-image="{$spage['page_picture_full']}" data-context="album" {/if}
                        src="{$spage['page_picture']}" alt="{$spage['page_title']}">

                    {if $spage['i_admin']}
                    <!-- buttons -->
                    <div class="profile-avatar-change">
                        <i class="fa fa-camera js_x-uploader" data-handle="picture-page"
                            data-id="{$spage['page_id']}"></i>
                    </div>
                    <div class="profile-avatar-crop {if $spage['page_picture_default']}x-hidden{/if}">
                        <i class="fa fa-crop-alt js_init-crop-picture" data-image="{$spage['page_picture_full']}"
                            data-handle="page" data-id="{$spage['page_id']}"></i>
                    </div>
                    <div class="profile-avatar-delete {if $spage['page_picture_default']}x-hidden{/if}">
                        <i class="fa fa-trash js_delete-picture" data-handle="picture-page"
                            data-id="{$spage['page_id']}"></i>
                    </div>
                    <!-- buttons -->
                    <!-- loaders -->
                ...
                <div class="profile-buttons-wrapper">
                    ...
                    <a target="_blank" href="{$spage['page_action_url']}"
                        class="btn btn-sm btn-{$spage['page_action_color']}">{$spage['page_action_text']}</a>
                    {/if}
                    <!-- custom button -->
                    ...
                    <div class="d-inline-block dropdown ml5">
                        <button type="button" class="btn btn-icon btn-rounded btn-light" data-toggle="dropdown"
                            data-display="static">
                            <i class="fa fa-ellipsis-v fa-fw"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- report -->
                            <div class="dropdown-item pointer js_report" data-handle="page"
                ...
                <div class="profile-tabs-wrapper custom-scrollbar">
                    <ul>
                        ...
                        <li>
                            <a href="{$system['system_url']}/pages/{$spage['page_name']}/products" {if $view=="products"
                                }class="active" {/if}>
            ...
            <div class="row">
                ...
                <div class="order-1 col-lg-3 order-lg-1">
                    ...
                    <!-- social links -->
                    {if $spage['page_social_facebook'] || $spage['page_social_twitter'] || $spage['page_social_youtube']
                    || $spage['page_social_instagram'] || $spage['page_social_linkedin'] ||
                    $spage['page_social_vkontakte']}
                    <div class="card">
                        <div class="card-header bg-transparent">
                ...
                <div class="order-2 col-lg-3 order-lg-3">
                    ...
                    <div class="card panel-photos">
                        <div class="card-header bg-transparent">
                            ...
                            <strong><a
                                    href="{$system['system_url']}/pages/{$spage['page_name']}/photos">{__("Photos")}</a></strong>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header bg-transparent">
                            <div class="float-right">
                                <small><a href="{$system['system_url']}/pages/{$spage['page_name']}/invites">{__("See
                                        All")}</a></small>
                            </div>
                            <i class="fa fa-user-tag mr5"></i>
                            <strong><a href="{$system['system_url']}/pages/{$spage['page_name']}/invites">{__("Invite
                                    Friends")}</a></strong>
                        </div>
                        <div class="card-body">
                            <ul>
                ...
                <div class="container mt20 offcanvas">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-3 offcanvas-sidebar">
                            ...
                            {if $spage['i_admin']}
                            <div class="mb10">
                                <button type="button" class="btn btn-sm btn-success btn-block rounded-pill"
                                    ...
                                    <div class="card product">
                                        <div class="product-image">
                                            ...
                                            <div class="product-overlay">
                                                ...
                                                <button type="button"
                                                    class="btn btn-sm btn-info rounded-pill js_chat-start"
                                                    data-uid="{$post['author_id']}"
                                                    data-name="{$post['post_author_name']}"><i
                                                        class="fa fa-comments mr5"></i>{__("Buy")}</button>
                                                {/if}
                                            </div>
                                        </div>
                                        <div class="product-info">
                                            ...
                                            <div class="product-meta">
                                                ...
                                                {if $post['product']['status'] == "gold"}{__("Gold")}{/if}
                                                {if $post['product']['status'] == "platinum"}{__("Platinum")}{/if}
                                                {if $post['product']['status'] == "diamond"}{__("Diamond")}{/if}
                                            </div>
                                            <div class="product-meta">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category" id="category">
                                        ...
                                        data_category=$spage['page_category']}
                                        {/foreach}
                                    </select>
                                </div>
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#action" data-toggle="tab">
                                        <i class="fa fa-magic fa-fw mr5"></i><strong class="pr5">{__("Action
                                            Button")}</strong>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#social" data-toggle="tab">
                                        <i class="fab fa-facebook fa-fw mr5"></i><strong class="pr5">{__("Social
                                            Links")}</strong>
                                    </a>
                                </li>
                            </ul>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text bg-transparent"><i
                                                                class="fab fa-vk fa-lg"
                                                                style="color: #527498"></i></span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="x-image full">
                                                    ...
                                                    <i class="fa fa-camera fa-2x js_x-uploader"
