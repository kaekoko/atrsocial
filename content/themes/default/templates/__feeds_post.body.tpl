    ...
    <div class="post-meta">
        ...
        <div class="float-right dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right post-dropdown-menu">
                ...
                <div class="dropdown-item pointer" data-toggle="modal"
                    data-url="posts/funding.php?do=edit&post_id={$_post['post_id']}">
                    <div class="action no-desc">
                ...
                <div class="dropdown-item pointer" data-toggle="modal"
                    data-url="posts/offer.php?do=edit&post_id={$_post['post_id']}">
                    <div class="action no-desc">
                ...
                <div class="dropdown-item pointer" data-toggle="modal"
                    data-url="posts/job.php?do=edit&post_id={$_post['post_id']}">
                    <div class="action no-desc">
                ...
                <div class="dropdown-item pointer js_hide-author" data-author-id="{$_post['user_id']}"
                    ...
                    <div class="action">
                        <i class="fa fa-minus-circle fa-fw"></i> {__("Unfollow")} {if
                        $system['show_usernames_enabled']}{$_post['user_name']}{else}{$_post['user_firstname']}{/if}
                    </div>
        ...
        <i data-toggle="tooltip" data-placement="top" title='{__($_post[' package_name'])} {__('Member')}'
        ...
        <span class="post-title">
            ...
            <i class="fa fa-caret-right ml5 mr5"></i><i class="fa fa-users ml5 mr5"></i><a
                href="{$system['system_url']}/groups/{$_post['group_name']}">{$_post['group_title']}</a>
        ...
        <div class="post-time">
            <a href="{$system['system_url']}/posts/{$_post['post_id']}" class="js_moment"
            ...
            !$_post['in_group'] && !$_post['in_event'] && $_post['post_type'] != "article" && $_post['post_type'] !=
            "product" && $_post['post_type'] != "funding"}
            <!-- privacy -->
            {if $_post['privacy'] == "me"}
            <div class="btn-group" data-toggle="tooltip" data-placement="top" data-value="me"
                ...
                <div class="btn-group" data-toggle="tooltip" data-placement="top" data-value="friends"
                    ...
                    {elseif $_post['privacy'] == "public"}
                    <i class="fa fa-globe" data-toggle="tooltip" data-placement="top"
        ...
        <!-- post text -->
        {if $_post['post_type'] != "product" && $_post['post_type'] != "funding" && $_post['post_type'] != "offer" &&
        $_post['post_type'] != "job"}
        {if !$_shared}
        ...
        <div
            class="post-snippet {if in_array($_post['origin']['post_type'], ['product', 'funding', 'job', 'poll'])}pb15{/if}">
            {if $_snippet}
        ...
        <div class="mt10">
            <div class="post-media">
                ...
                <div class="post-media-meta">
                    <a class="title mb5" href="{$_post['link']['source_url']}" target="_blank"
                        rel="nofollow">{$_post['link']['source_title']}</a>
        ...
        <div class="overflow-hidden">
            <video class="js_videojs video-js vjs-fluid vjs-default-skin"
        ...
        {elseif $_post['post_type'] == "photos" || $_post['post_type'] == "album" || $_post['post_type'] ==
        "profile_picture" || $_post['post_type'] == "profile_cover" || $_post['post_type'] == "page_picture" ||
        $_post['post_type'] == "page_cover" || $_post['post_type'] == "group_picture" || $_post['post_type'] ==
        "group_cover" || $_post['post_type'] == "event_cover" || ($_post['post_type'] == "product" &&
        $_post['photos_num'] > 0)}
        ...
        <div class="post-map">
            <img src="https://maps.googleapis.com/maps/api/staticmap?center={$_post['location']}&amp;zoom=20&amp;size=600x250&amp;maptype=roadmap&amp;markers=color:red%7C{$_post['location']}&amp;key={$system['geolocation_key']}"
                width="100%">
        </div>
        ...
        <div class="mt10">
            <div class="post-media">
                ...
                <a class="post-media-image"
                    ...
                    <div
                        style="padding-top: 50%; background-size: cover; background-image:url('{$system['system_uploads']}/{$_post['article']['cover']}');">
                    </div>
                </a>
                {/if}
                <div class="post-media-meta">
        ...
        <div class="mt10">
            <div class="post-media">
                <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank">
                    <div class="image"
                        style="background-image:url('{$system['system_uploads']}/{$_post['funding']['cover_image']}');">
                    </div>
                    <div class="icon">
            ...
            <div class="post-funding-meta">
                <div class="funding-title mb10 mt20">
                    <a href="{$system['system_url']}/posts/{$_post['post_id']}"
                        target="_blank">{$_post['funding']['title']}</a>
                </div>
                <div class="funding-completion mb10 mt20">
                    <span class="float-right">{$_post['funding']['funding_completion']}%</span>
                    <strong>{print_money($_post['funding']['raised_amount'])} {__("Raised of")}
                        {print_money($_post['funding']['amount'])}</strong>
                    <div class="progress mt5">
                        <div class="progress-bar progress-bar-info progress-bar-striped" role="progressbar"
                            aria-valuenow="{$_post['funding']['funding_completion']}" aria-valuemin="0"
                            aria-valuemax="100" style="width: {$_post['funding']['funding_completion']}%"></div>
                    </div>
                </div>
                ...
                <div class="mt10 clearfix">
                    <button type="button" class="btn btn-success btn-block js_funding-donate" data-toggle="modal"
                        data-url="#funding-donate"
                        data-options='{literal}{{/literal}"post_id": {$_post["post_id"]}{literal}}{/literal}'>
        ...
        <div class="mt10">
            <div class="post-media">
                <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank">
                    <div class="image"
                        style="background-image:url('{$system['system_uploads']}/{$_post['offer']['thumbnail']}');">
                    </div>
                    <div class="source">
                        <i class="far fa-calendar-alt mr5"></i>{__("Expires")}:
                        <strong>{$_post['offer']['end_date']|date_format:"%d/%m/%Y"}</strong>
                    </div>
                    <div class="icon">
                ...
                <div class="post-media-meta">
                    <a class="title mb5 mt20" href="{$system['system_url']}/posts/{$_post['post_id']}"
                        target="_blank">{$_post['offer']['meta_title']}</a>
                    <!-- post text -->
                    {if !$_shared}
                    {include file='__feeds_post.text.tpl'}
                    {else}
        ...
        <div class="mt10">
            <div class="post-media">
                <a class="post-media-image" href="{$system['system_url']}/posts/{$_post['post_id']}" target="_blank">
                    <div class="image"
                        style="background-image:url('{$system['system_uploads']}/{$_post['job']['cover_image']}');">
                    </div>
                    <div class="source">
                        <strong>{print_money($_post['job']['salary_minimum'])} -
                            {print_money($_post['job']['salary_maximum'])} /
                            {$_post['job']['pay_salary_per_meta']}</strong>
                    </div>
                    <div class="icon">
            ...
            <div class="post-job-meta">
                <div class="job-title mb10 mt20">
                    <a href="{$system['system_url']}/posts/{$_post['post_id']}"
                        target="_blank">{$_post['job']['title']}</a>
                </div>
                ...
                <div class="mt10 clearfix">
                    <button type="button" class="btn btn-primary btn-block js_job-apply" data-toggle="modal"
                        data-url="posts/job.php?do=candidates&post_id={$_post['post_id']}" {if
                        $_post['job']['candidates_count']==0}disabled{/if}>
                ...
                <div class="mt10 clearfix">
                    <button type="button" class="btn btn-success btn-block js_job-apply" data-toggle="modal"
                        data-url="posts/job.php?do=application&post_id={$_post['post_id']}">
            ...
            <div class="mb5">
                <div class="poll-option js_poll-vote" data-id="{$option['option_id']}"
                    ...
                    <div class="percentage-bg" {if $_post['poll']['votes']> 0} style="width:
                        {($option['votes']/$_post['poll']['votes'])*100}%"{/if}></div>
        ...
        <div class="overflow-hidden">
            <video class="js_videojs video-js vjs-16-9 vjs-default-skin"
                ...
                controls preload="auto" muted="muted" style="width:100%;height:100%;" width="100%" height="100%">
        ...
        <div class="post-product-container">
            ...
            <div class="mt10 clearfix">
                <button type="button" class="btn btn-info btn-block js_chat-start" data-uid="{$_post['author_id']}"
